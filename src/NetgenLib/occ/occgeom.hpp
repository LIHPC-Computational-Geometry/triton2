...
#define NG_OCCGEOMETRYVISUALIZATIONNOCHANGE   0
#define NG_OCCGEOMETRYVISUALIZATIONFULLCHANGE 1  // Compute transformation matrices and redraw
#define NG_OCCGEOMETRYVISUALIZATIONHALFCHANGE 2  // Redraw
   ...
   OCCGeometry * LoadOCC_Shape(TopoDS_Face& AFace);
   ...
   // @ACornerNodes location of corners' nodes by consecutive 3-uple (x,y,z)
   // @ACurveNodes location of curves' nodes by consecutive 3-uple (x,y,z)
   extern void OCCFindEdges (OCCGeometry & geom, Mesh & mesh,
