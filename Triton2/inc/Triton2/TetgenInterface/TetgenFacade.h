...
public:
     ...
     */
	void generateCDTMesh(gmds::IGMesh& ABoundaryMesh,
...
/*------------------------------------------------------------------------*/
     ...
     *	\param AQuality 	 defines a quality target size for each tetrahedron
     */
	void generateTetMeshDistTet(gmds::IGMesh& ABoundaryMesh,
						gmds::IGMesh& AVolMesh,
						const double AQuality = 2.0);
...
private:
     ...
     */
	void buildTetgenInput(gmds::IGMesh& AMesh);
	...
	void fillGMDSOutput(gmds::IGMesh& AMesh, std::vector<gmds::Node>& ANodes);

	void fillGMDSOutput(gmds::IGMesh& AMesh,
